...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        //plantillas
        Gate::define('plantilla_access', function ($user) {
            return in_array($user->role_id, [1]);
        });

        Gate::define('plantilla_create', function ($user) {
            return in_array($user->role_id, [1]);
        });
        Gate::define('plantilla_edit', function ($user) {
            return in_array($user->role_id, [1]);
        });
        ...
        Gate::define('folders_clientes', function ($user) {
